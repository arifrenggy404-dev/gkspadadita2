...
<style>
    ...
    .icon-isi     { color: #6B7280; }
    .icon-file    { color: #7c3aed; }
...
<div class="page-wrapper">
    ...
    <div class="page-header mb-4">
        ...
        <h4>Tambah Warta Mimbar Baru</h4>
        <p>Isi data lengkap warta mimbar di bawah ini.</p>
    </div>
        ...
        <div class="form-card-body">
            <form action="{{ route('warta.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="field-section">
                    ...
                    <div>
                        ...
                        <textarea class="form-control @error('isi_warta') is-invalid @enderror"
                                  ...
                                  rows="6"
                                  placeholder="Tuliskan isi warta mimbar di sini...">{{ old('isi_warta') }}</textarea>
                        @error('isi_warta')
                ...
                <div class="field-section">
                    ...
                    <div>
                        <label for="file" class="form-label fw-semibold small">Unggah File</label>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-save">
                        <i class="bi bi-check-circle-fill"></i>Simpan Warta
                    </button>
                </div>
