...
<div class="page-wrapper">
    ...
    <div class="page-header mb-4">
        ...
        <h4>Tambah Jadwal Kegiatan Baru</h4>
        <p>Isi data lengkap jadwal kegiatan gereja di bawah ini.</p>
    </div>
                ...
                <div class="field-section">
                    ...
                    <div>
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                  ...
                                  rows="4"
                                  placeholder="Tuliskan detail singkat kegiatan...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
