...
<div class="page-wrapper">
    ...
    <div class="page-header mb-4">
        ...
        <p>Perbarui informasi jadwal ibadah di bawah ini.</p>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-body">
            <form action="{{ route('ibadah.update', $jadwal->id_ibadah) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="field-section">
                    ...
                    <div>
                        <label for="pelayan" class="form-label fw-semibold small">Pelayan</label>
                        <div class="input-group-icon">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('pelayan', $jadwal->pelayan) }}"
                                   placeholder="Contoh: Pdt. ..." required>
                        </div>
                        @error('pelayan')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                ...
                <div class="field-section">
                    ...
                    <div>
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                  ...
                                  rows="3"
                                  placeholder="Contoh: Ibadah Pemuda / Pelayan Firman: Pdt. X">{{ old('keterangan', $jadwal->keterangan) }}</textarea>
                        @error('keterangan')
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-save">
                        <i class="bi bi-check-circle-fill"></i>Perbarui Jadwal
                    </button>
                </div>
