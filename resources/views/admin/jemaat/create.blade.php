...
<style>
    ...
    .btn-reset i { color: #d97706; font-size: 1rem; }
    .btn-reset:hover { border-color: #1a2744; color: #1a2744; }
...
<div class="page-wrapper">
    ...
    <div class="page-header mb-4">
        ...
        <h4>Tambah Jemaat Baru</h4>
        <p>Isi data lengkap jemaat baru di bawah ini.</p>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-body">
            <form action="/jemaat" method="POST">
                @csrf
                ...
                <div class="field-section">
                    ...
                    <div>
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror"
                                  ...
                                  placeholder="Masukkan alamat lengkap jemaat" required>{{ old('alamat') }}</textarea>
                        @error('alamat')
